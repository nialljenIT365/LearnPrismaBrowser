...
Interacting with IDPs..........................................................................................................................................................................13

Security Functions............................................................................................................................................................................. 14

Browser Policy...................................................................................................................................................................................18

Combining Prisma Browser with Prisma Access............................................................................................................................... 21

Prisma Browser Mobile App and Browser Extension.........................................................................................................................25

Browser Enforcement........................................................................................................................................................................ 26

Browser Distribution...........................................................................................................................................................................28
...
This guide provides architectural guidance and discusses decision criteria for using Palo Alto Networks [®] Prisma [®] Browser

and Prisma Access in order to achieve an integrated design. This reference architecture guide provides you with a framework

for securely accessing applications from end-user devices, providing security and visibility for your workforce.
...
This guide supports the following:
   ...
   - [Securing Internet and Private Applications by Using Prisma Browser and Prisma Access: Deployment Guide—](https://architectures.link/2076p-prime)

Provides implementation details for securely accessing internet and private applications using Prisma Browser

and Prisma Access. Includes high-level tasks and step-by-step configuration details for both browser and SASE

enforcement strategies, including last-mile controls, Enterprise DLP, and cloud-delivered security services across
...
generation firewalls.
   ...
   - [Mitigating Data-Exfiltration Risk by sing Enterprise DLP: Solution Guide—Provides design and deployment](https://architectures.link/2147p-prime)
...
When planning to secure web access and protect sensitive data across managed and unmanaged devices, you must

identify their critical web applications, data locations, and remote user footprint. With this information, they can use security

capabilities from Palo Alto Networks in order to secure web access and protect sensitive data across managed and
...
Integrating Prisma Browser with Prisma Access extends its full security enforcement to browser traffic. Your organization can

apply its existing Prisma Access policies and inline inspection while layering granular controls at the browser level. Prisma

Access also allows users to securely access private enterprise applications directly from the browser.
...
and unauthorized application access.
...
Strata Cloud Manager (SCM) is a cloud-based, multi-region management solution that acts as a unified control center for an

organization’s entire network security infrastructure, bringing together next-generation firewalls (NGFWs), Prisma Access, and

Prisma Browser deployments into one centralized, cloud-based platform.


Within SCM, administrators configure and manage each product through its own workflows, pushing the appropriate policy

based on user and device posture. SCM keeps Prisma Access and Prisma Browser current with the latest updates and

policies and provides administrators with deep visibility into both deployments, along with monitoring of user activity across

the environment.


Prisma Access and Prisma Browser send log data to Strata Logging Service (SLS), with each product writing to its own log

set that administrators can review in the SCM console. These logs offer detailed insights into user and traffic and network
level events such as application access and threat detections. This detailed information equips IT personnel with a deep

understanding of user behavior and creates an audit trail that is invaluable for incident response.
...
Prisma Access is a cloud-delivered secure-access service-edge (SASE) platform that provides secure connectivity and

consistent security policy for users, branches, and applications. The platform combines zero-trust network access (ZTNA),

secure web gateway (SWG), firewall as a service, and cloud-delivered security services (CDSS) into a single cloud-native

service, delivering protection close to users regardless of their connection location. Prisma Access also enables secure

connectivity to private applications hosted on-premises or in private clouds.


To seamlessly onboard your users to Prisma Access, you connect remote workers by using a dedicated VPN agent (such as

GlobalProtect [®] or Prisma Agent) or an explicit proxy. When connected, your users can securely browse the public internet

and SaaS applications with full threat inspection. They can also access private applications hosted on-premises or in private

clouds. To reach these internal resources, you can use service connections or ZTNA Connectors to create connections from

Prisma Access to their data centers or private cloud environments.


You can integrate Prisma Browser with Prisma Access to extend your existing security enforcement and policy controls

directly to browser traffic, giving your users a secure path to private applications. While Prisma Access provides the robust

security foundation, Prisma Browser can build upon it with specialized, browser-native protections. This layered defense

gives you granular control over user actions such as copy/paste actions, unauthorized screenshots, and unlocks deep

visibility into SaaS session activity. Integrating Prisma Browser with Prisma Access supports both connection paths:

managed devices typically reach Prisma Access through a VPN agent for full tunnel coverage, while unmanaged devices are

a natural fit for the explicit proxy path because you don't need to install a client.


[For more information about Prisma Access and its features, see the Securing Internet for Mobile Users by Using Tunnel](https://architectures.link/2014p-prime)

[Mode: Design Guide.](https://architectures.link/2014p-prime)
...
comprehensive visibility enables granular last-mile controls. You can define precise policy for file uploads and downloads,

copy and paste actions, printing, screenshots, and more, and apply that policy at the exact moment a user interacts with
...
CDSS. Powered by AI and machine learning, this comprehensive suite of cloud-based protections analyzes web interactions

directly at the browser edge, enabling you to detect and stop evasive threats in real time without degrading the user
...
### COMBINING PRISMA BROWSER WITH PRISMA ACCESS

For organizations that already have Prisma Access deployed for mobile user access, you can seamlessly integrate Prisma

Browser with Prisma Access.


The strength of this solution comes from these capabilities:


   - Secure private-application access—By routing Prisma Browser traffic through Prisma Access, you secure

connectivity to private applications that are hosted on-premises or in private clouds. This enables employees to safely

reach critical internal resources from any location. When using a tunnel-mode connection method for secure access,

you gain full support for thick applications that rely on non-HTTP/S ports and protocols.


   - Integrated policy enforcement—Although Prisma Browser and Prisma Access share common management with

SCM, you maintain their individual policies separately. However, you can apply and reuse the existing policies that

you developed for Prisma Access mobile users when routing browser traffic through Prisma Access. Prisma Browser

then layers on browser-specific controls, such as copy/paste restrictions, screenshot prevention, and extension

governance, that network inspection cannot see or control.


   - Comprehensive inline inspection—Prisma Access inspects traffic across all ports and protocols, providing visibility

and control beyond the browser’s native web-based security. This provides a much deeper level of threat protection

and applies CDSS consistently to browser traffic alongside all other traffic traversing Prisma Access.

##### **Connecting to Prisma Access**

Prisma Access provides different connection methods depending on whether your user’s device is managed or unmanaged.


Managed devices typically connect to Prisma Access through the Prisma Access agent or the GlobalProtect app, which

support two connection modes:


   - Tunnel mode—Extends Prisma Access's visibility and control of all network traffic, applications, ports, and protocols

to the user for secure access to applications for all protocols. Mobile users connect to Prisma Access in tunnel mode

by using the Prisma Access agent or the GlobalProtect app.


   - Proxy mode—Extends Prisma Access's visibility and control of all network traffic, applications, ports, and protocols

to the user in order to secure access to applications that use HTTP and HTTPS protocols. Mobile users connect to

Prisma Access SWG in proxy mode by using the Prisma Access agent or the GlobalProtect app.


Prisma Browser enables unmanaged devices to connect to enterprise applications through Prisma Access SWG, which uses

a managed PAC file to route browser traffic to Prisma Access, without requiring an endpoint agent. This configuration makes

Prisma Browser well-suited for contractors, BYOD users, and other scenarios where deploying an agent is impractical, while

still allowing your organization to apply Prisma Access security policy and controls to user traffic.
...
The VPN agent method routes traffic to Prisma Access through an established VPN tunnel-mode connection. This method

requires either the GlobalProtect app or the Prisma Access agent to be installed on the endpoint and connected to your

Prisma Access tenant. When the agent is running and connected, all traffic goes through the tunnel except for address

ranges that you specify for split tunneling. The advantage of this approach is that it protects everything on the device, not just

browser traffic, which is necessary when supporting native desktop applications.


_Figure 5_ _VPN agent path_


If you already have a Prisma Access VPN agent deployment, the existing Prisma Access policy also applies to Prisma

Browser traffic using the VPN. This means you can keep your current policy intact and layer the additional controls of Prisma

Browser on top of it. This approach is ideal for organizations already using GlobalProtect or the Prisma Access agent on

managed devices. It's also ideal for environments that require protection for native desktop applications alongside browser
...
When using a VPN agent with Prisma Browser, you should enable these two features:


   - Agent detection—This feature checks if a supported VPN agent (GlobalProtect or Prisma Access agent) service is

currently running on the endpoint. When you enable agent detection and it detects an active agent session, Prisma

Browser suppresses the PAC file so the endpoint defers to the agent’s routing and does not require or use a proxy

configuration.

|Col1|Col2|Note|
|---|---|---|
|Agent detection triggers based on the service running, not the connection state. If the<br> agent service is running but the tunnel is down, the PAC file remains suppressed. In<br> this case, the endpoint does not have a path to access private application traffic.|Agent detection triggers based on the service running, not the connection state. If the<br> agent service is running but the tunnel is down, the PAC file remains suppressed. In<br> this case, the endpoint does not have a path to access private application traffic.|Agent detection triggers based on the service running, not the connection state. If the<br> agent service is running but the tunnel is down, the PAC file remains suppressed. In<br> this case, the endpoint does not have a path to access private application traffic.|



   - Internal host detection—This feature checks whether the device can resolve a designated internal IP address

or domain. If the resolution is successful, it confirms the user is on the corporate network and routes traffic locally

instead of sending it to Prisma Access.


**Explicit Proxy**

The explicit proxy method routes browser traffic to Prisma Access by using a PAC file, with no agent required on the

endpoint. Prisma Browser manages the PAC file itself, so you don’t need to deploy or maintain it manually. You can choose

to route all browser traffic through Prisma Access, or only traffic destined for private applications. When private applications

are defined in SCM, Prisma Browser automatically updates the PAC file so the browser knows which traffic to send through

Prisma Access.


_Figure 6_ _Explicit proxy path_


Because explicit proxy is a web proxy, it secures only traffic that passes through the browser. If your organization also needs

to protect native desktop applications, you should consider the VPN agent option instead. Explicit proxy is generally the ideal

fit for unmanaged devices, organizations that prefer not to deploy an agent, or environments where security requirements are

strictly scoped to browser-based work.
...
##### **Supporting Managed and Unmanaged Devices in a Single Architecture**

Explicit proxy and VPN agents are not mutually exclusive; your organization can seamlessly secure both managed and

unmanaged devices within the same environment.


Prisma Browser uses the agent detection feature to dynamically determine traffic routing on a per-device basis:


   - Managed Devices (VPN agent active)—If the agent service is running and you have enabled agent detection, the

browser suppresses the PAC file and the system routes traffic through the VPN agent tunnel.


   - Unmanaged Devices (VPN agent absent)—If the agent service is not installed, the PAC file remains active and the

system routes browser traffic through the Prisma Access SWG by using proxy mode.

##### **Reaching Private Applications**

Regardless of the user's connection method (VPN agent or explicit proxy), Prisma Access must have a direct line to the

environment hosting your private applications. You create this backend connection by using either a Prisma Access Service

Connection or a Prisma Access ZTNA Connector.


_Figure 7_ _Private application access_


Because Prisma Browser traffic is subject to the same Prisma Access security policy as any other traffic traversing the

service, you must also have a security policy rule in place that allows the browser’s traffic to reach its intended destination,

whether that’s private applications or the internet. Without an allow rule, Prisma Access drops the traffic even when you

configure the connectivity path correctly.

##### **Policy Considerations**

Prisma Browser and Prisma Access are separate enforcement points with independent policy management. Each has its

own policy framework, and the two are not unified into a single ruleset. This means you have flexibility in how you architect

enforcement, but it also means you need to think deliberately about where each policy lives and what it covers.


If you already have a mature Prisma Access deployment with established security policies, Prisma Browser can augment that

enforcement by adding browser-layer controls that Prisma Access cannot see or act on, things like copy/paste, screenshot

prevention, and deep visibility. In this model, Prisma Access continues to handle network-layer enforcement while Prisma

Browser layers on application-context controls.


Alternatively, you can shift more of your enforcement into the browser itself, using Prisma Access primarily for connectivity

to private applications and relying on the browser for the bulk of user-facing security policy. This approach can simplify the

network path for SaaS and internet traffic and reduces dependency on tunnel health for security enforcement.
...
##### **How Traffic Routing Affects Enforcement**

The split between these two enforcement points depends on how traffic is routed to Prisma Access in the first place.


If you deploy Prisma Access specifically for private application access, the system evaluates Prisma Access policy only when

users reach those private destinations. General internet and SaaS traffic bypasses Prisma Access entirely, relying strictly on

the security policies you enforce within Prisma Browser and the SaaS applications. In this case, Prisma Browser is doing the

heavy lifting for the majority of user traffic.


If you use a solution like Prisma Access Agent or GlobalProtect in full-tunnel mode, the endpoint forwards all traffic to Prisma

Access regardless of destination. As a result, Prisma Access evaluates its security policy on every single traffic flow. Prisma

Browser policy then sits on top of that for browser-based sessions, giving you defense in depth for web and SaaS traffic. The

trade-off is that you now have two policy surfaces touching the same traffic, which is powerful but requires coordination so

the two layers complement rather than duplicate or contradict each other.
...
Available for iOS, iPadOS, and Android devices, the Prisma Browser mobile app extends your secure workspace to mobile
...
_Figure 8_ _Prisma Browser authentication_
...
_Figure 9_ _Conditional access policy_
...
The Prisma Access Enterprise Browser is licensed as an add-on to Prisma Access and requires an underlying mobile user

license to operate.


   - Prisma Access Enterprise Tier: Included automatically as a 0$ add-on license.


   - SWG or ZTNA Tiers: Available for purchase as an additional add-on license.


Minimum quantity requirements: There is a 200-license minimum required to allocate a tenant.
...
There are many ways to build a secure architecture by using the concepts discussed in this guide. The design model

provides secure access to the internet and SaaS applications using Prisma Browser and also provides secure access to

private applications by using Prisma Browser integrated with Prisma Access. This design model assumes you have an

existing Prisma Access deployment that uses either Prisma Agent or GlobalProtect for managed devices. Introducing Prisma

Browser to this infrastructure strengthens security for managed devices and establishes a safe, frictionless pathway for BYOD
...
_Figure 10_ _Managed device flow_
...
_Figure 11_ _Unmanaged Device Flow_
...
Prisma Browser extension or an MDM solution, to prevent unauthorized browsers from running on user devices. Together,

these layers provide comprehensive coverage against unauthorized access.
...
To extend this secure workspace to your internal resources, you route traffic through Prisma Access by using either a VPN

agent or an explicit proxy. This approach grants your users seamless, high-performance access to private web applications

and extends your Prisma Access benefits to your Prisma Browser users.
...
[You can use the feedback form](https://www.paloaltonetworks.com/resources/reference-architectures/feedback-ra?guid=2075p-16062026) to send comments about this guide.
