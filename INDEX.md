...
| [PROJECT-STATUS.md](PROJECT-STATUS.md) | — | **Session handoff / where things stand** — working conventions, Q&A already answered, open threads. Update at the end of each working session. |
